...
urlpatterns = [
    ...
    path('api/skills/<int:skill_id>/details/', views.api_skill_details, name='api_skill_details'),
    path('api/add_prerequisite/', views.api_add_prerequisite, name='api_add_prerequisite'),
